...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="w3-container" id="contact">
    ...
    <form method="post">
	  ...
	  <p><input class="w3-input w3-border" type="text" placeholder="Description" maxlength="500" required name="description"></p>
	  
		             <br>
					 
    
	 
    <button type="submit" class="w3-button w3-green w3-third" name="propose" value="propose">Propose</button>
    </form>
	</div>
	<br>
	<br>
