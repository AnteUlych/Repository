...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
   <div class="w3-container" id="contact">
    <h2>${route}</h2>
    <i class="fa fa-map-marker" style="width:30px"></i>Route: ${transport.route}<br>
    <i class="fa fa-clock-o" style="width:30px"></i>Pick Up: ${transport.readiness}<br>
    <i class="fa fa-thermometer" style="width:30px"> </i>truck: ${transport.truckdriver} ${transport.information}<br>
  ...
  <div class="w3-container">
	...
	<a href="/probe/addproposition/${transport.id}" class="w3-bar-item w3-button w3-padding">Add Proposition</a><br>
	<form method="post">
	<c:forEach items="${propositions}" var="proposition" varStatus="theCount">

<tr class="${proposition.status}">
<td>${proposition.date}</td>
<td>${proposition.readiness}</td>
<td>${proposition.route}</td>
<td>${proposition.information}</td>
<td>${proposition.price} EUR</td>
...
<a href="/probe/editransport/${transport.id}" class="w3-bar-item w3-button w3-padding">Truck Number</a>
