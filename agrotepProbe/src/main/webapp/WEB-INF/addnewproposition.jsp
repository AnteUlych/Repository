...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    ...
    <form method="post">
	  ...
	  <p><input class="w3-input w3-border" type="number" placeholder="EUR" min="1" max="50000" required name="priceEuro"></p>
	  <br>

    
<br>
	 
    <button type="submit" class="w3-button w3-green w3-third" name="add" value="add">Add Proposition</button>
    </form>
  </div>
  <hr>
