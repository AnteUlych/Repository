						...
						<div class="resp-tabs-container">
							...
							<div class="tab-1 resp-tab-content">
								...
								<whitecolour>
	                             ...
	                             ${transport} delivery:<br><br>
                                 ${way};<br><br>
	                             Tariff - ${price} USD, transit time -  ${time} days.<br>
	
									 </whitecolour>
									 
								      <form method="post" class="agile_form">
	
	                                      <input placeholder="Date" class="date" name="date" id="datepicker" type="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required=""/>
	                                      <input type="text" placeholder="Your Name" name="name" class="name agileits" required=""/>
										  <input type="text" placeholder="Your Company" name="company" class="name agileits" required=""/>
										  <input type="text" placeholder="Your Mail" name="mail" class="name agileits" required=""/>
										  <input type="text" placeholder="Your Phone" name="phone" class="name agileits" required=""/>
										  <br><br>
										  <div class="submit" >                                
