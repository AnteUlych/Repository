...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-truck  w3-text-blue"></i> Автомобілі</b> <button onclick="document.getElementById('subscribe').style.display='block'" class="w3-button w3-xlarge w3-circle w3-white">+</button></h5>
  </header>
  ...
  <div class="w3-container">
    ...
    <tr  class="${statusTrucks[theCount.index]}">
    <td>${theCount.index+1}</td>
    <td><a href="/planner/truck/${trucksh.id}">${trucksh.tracktor}/${trucksh.trailer}</a></td>
    <td>${trucksh.type}</td>
  ...
  <div class="w3-modal-content  w3-padding-large">
    <div class="w3-container w3-white w3-center">
      ...
      <p>&nbsp;</p>
         ...
         <input type="radio" id="total" name="typetruck" value="цільномет">
         <label for="total">цільномет</label>
	     </p>
	     
	       <p>Відповідальний:&nbsp; 
	       <c:forEach items="${managers}" var="manager" varStatus="theCount">       
	     <input type="radio" id="${manager.id}" name="manar" value="${manager.name}" required>
