    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-third">
       ...
       <h5><b>По рейсу: ${circleinfo}</b></h5><br>
		...
		<div class="align-left"><a href="/planner/newRoute3/${cellForNewRoute}">Прибрати</a></div><br>
		<div id="locationField">
		<p><input id="autocomplete4" name="googleAddress4" class="w3-input w3-border" type="text" placeholder="місце зупинки" required>   </p>
		...
		<p><input class="w3-input w3-border" name="priceFromClient" type="number" placeholder="грн" value="${valuePrice}" required>  </p>
           ...
           <option value="Клієнт" selected>Клієнт</option>
...
function fillInAddress4() {
	...
	console.log(place4.geometry.location.lng());
	console.log(place4.geometry.location.lat());
	var longitude9= place4.geometry.location.lng();
	var latitude10= place4.geometry.location.lat();
	document.getElementById('demo9').innerHTML = '<input type="hidden" name="lng9"  id="demo9" value="'+longitude9+'"></input>';
	document.getElementById('demo10').innerHTML = '<input type="hidden" name="lat10" id="demo10" value="'+latitude10+'"></input>';
}
