...
<button class="accordion">${truck.tracktor}/${truck.trailer} - ${truck.driver} (${truck.managerName}) - ${truck.totalKm} км, ${truck.totalUAHforKm} грн/км, &nbsp;<i class="fa fa-hourglass-end"></i> ${truck.totalStops} &nbsp;<i class="fa fa-wrench"></i> ${truck.totalRemont} &nbsp;<i class="fa fa-suitcase"></i> ${truck.totalColona}</button>
<div class="panel">
  <table>
