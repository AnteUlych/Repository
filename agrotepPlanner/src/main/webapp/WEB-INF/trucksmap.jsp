...
<nav class="w3-sidebar w3-collapse w3-white w3-card" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="/planner/trucksmapupdate" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-compass"></i>&nbsp;Оновити мапу</a>
...
<iframe src="${maplink}" style="position: absolute; height: 90%; border: none" width="90%">
</iframe>
