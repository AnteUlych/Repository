...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
   <form method="post">
    <h5><b><i class="fa fa-truck"></i> Архів плану відвантажень 
    з <input type="date" value="${dateStartText}" required name="start"> до <input type="date" value="${dateFinishText}" required name="finish">
    <button type = "submit" class="w3-button">&nbsp;<i class="fa fa-archive"></i></button>    
    </b></h5>
   </form>
  </header>
