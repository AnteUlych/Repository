...
<nav class="w3-sidebar w3-collapse w3-white" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="/tender/sold" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-lock fa-fw"></i> ${alertSold} &nbsp; Заброньовані автомобілі </a>
     ...
     <i class="fa fa-truck" style="width:30px"></i>${sol.information}, ${auction.truck}
      ...
      <p>    Вантажівка:</p>
	   <p>
                       ...
                       <input required type="radio" name="truck${sol.id}" value ="допельшток"> <label>допельшток</label>
