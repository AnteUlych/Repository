...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-truck"></i> План відвантажень (<a href="/bazaar/deals/export">Експорт</a> та <a href="/bazaar/deals/import">Імпорт</a>)</b></h5>
  </header>
...
<tr class="${colors[theCount.index]}">
				...
				<td><a href="/bazaar/deal/${dea.id}"><i class="fa fa-thumb-tack"></i></a></td>
