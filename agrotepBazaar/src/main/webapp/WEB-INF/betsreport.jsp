...
<nav class="w3-sidebar w3-collapse w3-white" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="/tender/clientspropositions" class="w3-bar-item w3-button w3-padding"><i class="fa fa-volume-control-phone fa-fw"></i>&nbsp; Контракти</a>
    ...
    <a href="/tender/report" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-bar-chart fa-fw"></i>&nbsp; Місячна звітність</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><i class="fa fa-bar-chart"></i> Тендер ${auction.route}, ${auction.truck}, ${auction.readiness}, ${auction.rate} ${auction.currency} 
    <a href="/tender/auctionreport/${datesLink}"><i class="fa fa fa-calculator"></i></a>
    </h5>
  </header>
</form>
  ...
  <div class="w3-container" id="contact">
	 ...
	 <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
		...
		<c:forEach items="${bets}" var="bet" varStatus="theCount">
