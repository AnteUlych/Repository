...
<nav class="w3-sidebar w3-collapse w3-white" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="/bazaar/auction" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-legal fa-fw"></i>&nbsp; Тендер автомобілів</a>
...
<td><a href="/bazaar/bets/${exportInfo.id}">${exportInfo.route}</a></td>
