...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><i class="fa fa-bar-chart"></i> Звіт по аукціонам з ${dateFrom} по ${dateTo} 
    <a href="/bazaar/report"><i class="fa fa fa-calculator"></i></a>
    </h5>
  </header>
</form>
...
<tr>
			    ...
			    <td>${auc.rate}</td>
			    <td>${auc.currency}</td>
			    <td><a href="/bazaar/betsreport/${dateFrom}_${dateTo}_${auc.auctionid}">${auc.betcount}</a></td>			   			
</tr>
