...
@Controller
//@RequestMapping("/editManagerConsole/{name}")
@RequestMapping("/editManagerConsole")
public class EditManagerConsole {
	
	@RequestMapping(method = RequestMethod.GET)
	//public String initForm(@PathVariable("name") String name, Model model) {
	...
	public String submitForm(Model model,HttpServletRequest request, HttpServletResponse res) {
