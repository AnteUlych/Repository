...
public class Service {
	...
	BookingService bookingService = (BookingService) ctx
	...
	public List<String> getAllManagersOfBookings() {
		...
		for (Booking booking : bookings) {
			managers.add(clientService.getClientByCompany(booking.getCompany())
					.getManager());
		}
		return managers;
	}
	...
	public boolean isAccess(String requestIp) {
		AccessService accessService = (AccessService) ctx
				.getBean("accessService");
