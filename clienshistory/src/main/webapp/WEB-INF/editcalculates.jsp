...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5>
    <b><i class="fa fa-book"></i> Редагування запиту</b>
...
<div class="w3-container w3-white w3-center">
 ...
 <form method="POST">
  ...
  <p>
         ...
         <option value="${calculate.companyid}">${calculate.company}</option>
        ...
        <option value="${c}">
	     ...
	     <input pattern="[^\\/`\/\x22]+" name="weight" class="w3-input w3-third" type="number" placeholder="Вага, т" value="${calculate.weight}"  min="1" max="24" required>
         <input pattern="[^\\/`\/\x22]+" name="temperature" class="w3-input w3-third" type="text" placeholder="Температурний режим" value="${calculate.temperature}" maxlength="40">
	     </p>
	     ...
	     <p>	 
	     <input pattern="[^\\/`\/\x22]+" name="budget" class="w3-input w3-half" type="text" placeholder="Ставка наша" value="${calculate.rate}" maxlength="40">
         <input pattern="[^\\/`\/\x22]+" name="rate" class="w3-input w3-half" type="text" placeholder="Ставка клієнта" value="${calculate.budget}" maxlength="40">
	     </p>
	     <br>
	     <br>
	     <p><input pattern="[^\\/`\/\x22]+" name="calculateonadate" class="w3-input w3-border" type="text" placeholder="Готовність вантажу" value="${calculate.calculateonadate}" maxlength="40" required></p>
	     <p><input pattern="[^\\/`\/\x22]+" name="comments" class="w3-input w3-border" type="text" placeholder="Інша інформація" value="${calculate.comments}" maxlength="450" ></p>
	   <br>
	    
	     Тип РС:&nbsp;
	     <input type="radio" id="tilt" name="typetruck" value="тент" ${tent} required>
         <label for="tilt">тент</label>
         <input type="radio" id="ref" name="typetruck" value="реф" ${ref}>
         <label for="ref">реф</label>
         <input type="radio" id="total" name="typetruck" value="будь який" ${tentref}>
         <label for="total">будь який</label>&nbsp; &nbsp;
         <input type="checkbox" id="adr" name="adr" value="adr" ${adr}>
         <label for="adr"> Небезпечний вантаж</label>
         <br>
	     <br>
		  <p><button name="add" type="submit" class="w3-button w3-padding-large w3-green w3-margin-bottom">Змінити</button></p>
