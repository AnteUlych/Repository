  ...
  <div class="w3-modal-content  w3-padding-large">
    <div class="w3-container w3-white w3-center">
      ...
      <p>&nbsp;</p>
	     ...
	     <input pattern="[^\\/`\/\x22]+" name="cityfrom" class="w3-input w3-quarter" type="text" placeholder="МІСТО ВІДПРАВКИ" maxlength="40">
	     <input style="text-transform:uppercase" pattern="[^\\/`\/\x22]+" name="countryfrom" class="w3-input w3-quarter" type="text" placeholder="Країна відправки" minlength="2" maxlength="2">
	  
	     <input pattern="[^\\/`\/\x22]+" name="cityto" class="w3-input w3-quarter" type="text" placeholder="МІСТО ДОСТАВКИ" maxlength="40">
	     <input style="text-transform:uppercase" pattern="[^\\/`\/\x22]+" name="countryto" class="w3-input w3-quarter" type="text" placeholder="Країна доставки" minlength="2" maxlength="2">
	     </p>
		 <p>	 
	     ...
	     <p><input pattern="[^\\/`\/\x22]+" name="comments" class="w3-input w3-border" type="text" placeholder="Інша інформація" maxlength="450" required></p>
	   <br>
