...
<nav class="w3-sidebar w3-collapse w3-white" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="/clientshisory/find" class="w3-bar-item w3-button w3-padding  w3-blue"><i class="fa fa-search"></i>&nbsp; Пошук </a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5>
    <form method="POST">
    <b><i class="fa fa-search"></i> Пошук:
    <input type="text" placeholder=" по назві або ЄДРПОУ" maxlength="50" required name="word">
    <button class="w3-button" type="submit" name="add" value="add"><i class="fa fa-search"></i></button>   
    </b>
     </form>
